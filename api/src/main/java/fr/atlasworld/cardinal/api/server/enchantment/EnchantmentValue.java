...
/**
 * Represents a mutable value of an enchantment.
 * <br><br>
 * This class is based of MutableFloat object from Apache Commons Lang.
 * Licensed under <a href="https://github.com/apache/commons-lang?tab=Apache-2.0-1-ov-file#readme">Apache 2.0</a>
 */
public final class EnchantmentValue extends Number implements Comparable<EnchantmentValue> {
    ...
    /**
     * Constructs a new EnchantmentValue with the default value of zero.
     */
    public EnchantmentValue() {
    }

    /**
     * Constructs a new EnchantmentValue with the specified value.
     *
     * @param value the initial value to store
     */
    public EnchantmentValue(final float value) {
        this.value = value;
    }
     ...
     */
    public EnchantmentValue(final Number value) {
        this.value = value.floatValue();
    }

    /**
     * Constructs a new EnchantmentValue parsing the given string.
     *
     * @param value the string to parse, not null
     * @throws NumberFormatException if the string cannot be parsed into a float
     * @since 2.5
     */
    public EnchantmentValue(final String value) {
     ...
     */
    @Override
    public int compareTo(final EnchantmentValue other) {
    ...
    /**
     * Returns the value of this EnchantmentValue as a double.
     *
    ...
    public boolean equals(final Object obj) {
        return obj instanceof EnchantmentValue
                && Float.floatToIntBits(((EnchantmentValue) obj).value) == Float.floatToIntBits(value);
    }

    /**
     * Returns the value of this EnchantmentValue as a float.
     *
    ...
    /**
     * Returns the value of this EnchantmentValue as an int.
     *
    ...
    /**
     * Returns the value of this EnchantmentValue as a long.
     *
